...
# Bot information *
SESSION = environ.get('SESSION', 'PSO_AUTOBOT')
API_ID = int(environ['7684469'])
API_HASH = environ['7289a31b2b539f5c92f39fa1a3c3ad6c']
BOT_TOKEN = environ['7518791498:AAFq982ctHMk71aFjRHyQBkQ-tZ-SOGS_dw']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('1256474673').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('-1002155116258').split()]
